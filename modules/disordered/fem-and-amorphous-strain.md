...
Amorphous rings are ideal for measuring elliptic distortion of the diffraction pattern, whether it comes from the projector lenses of the microscope or from strain in the sample. We fit the ring in polar coordinates, and an elliptic distortion appears as a sinusoidal modulation of the ring radius with azimuthal angle [B. Savitzky et al., Microscopy and Microanalysis 27, 712 (2021)]. We correct the instrumental distortion using a reference measurement before analyzing sample strain.

:::{figure} ../../images/slides/slide-065.jpg
:alt: amorphous ring in cartesian and polar coordinates showing elliptic distortion

An elliptically distorted amorphous ring and its polar transform. B. Savitzky et al., Microscopy and Microanalysis 27, 712 (2021).
:::

## Strain mapping of amorphous samples

Gammer et al. mapped strain in a metallic glass during in situ tensile loading by fitting an ellipse to the first amorphous ring at each probe position [C. Gammer et al., Applied Physics Letters 112, 171905 (2018)]. We fit
...
In situ tensile experiment and elliptical fit to the amorphous ring. C. Gammer et al., Applied Physics Letters 112, 171905 (2018).
:::
...
Strain maps of a metallic glass sample unloaded, under load, and after fracture. C. Gammer et al., Applied Physics Letters 112, 171905 (2018).
:::
